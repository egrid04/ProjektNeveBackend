...
namespace ProjektNeveBackend
{
    public class Program
    {
        ...
        public static async Task SendEmail(string mailAddressTo, string subject, string body)
        {
            ...
            mail.From = new MailAddress("nagy.pista.kkszki@gmail.com");
            ...
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("nagy.pista.kkszki@gmail.com", "zmxsgzquimypevcg");
